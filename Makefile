LANGUAGE_NAME := tree-sitter-macaulay2
HOMEPAGE_URL := https://github.com/d-torrance/tree-sitter-macaulay2
VERSION := 0.0.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/macaulay2 '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/macaulay2
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/macaulay2
